...
public class GlobalExceptionHandler {
    ...
    public Object handleException(Exception e) {
        ...
        return ApiRestResponse.error(StatusCode.SYSTEM_ERROR);
    }
    ...
    private ApiRestResponse handleBindingResult(BindingResult result) {
        ...
        if (list.size() == 0) {
            return ApiRestResponse.error(StatusCode.REQUEST_PARAM_ERROR);
        }
        return ApiRestResponse.error(StatusCode.REQUEST_PARAM_ERROR.getCode(), list.toString());
    }
}
